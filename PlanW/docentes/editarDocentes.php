...
<form name="form1" method="post" action="docenteeditado.php">
  <table class="table">

    <tr>
      <th scope="col">#</th>
      <td><input type='number' name='id_persona' value="<?php echo $id; ?>" readonly ></td>
    </tr>
    <tr>
      <th scope="col">DNI</th>
      <td><input type='text' name='DNI' value="<?php echo $dni; ?>" required></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type='text' name='apellido1' value="<?php echo $ap1; ?>" required></td>
    </tr>
    <tr>
      <th scope="col">Apellido 2</th>
      <td><input type='text' name='apellido2' value="<?php echo $ap2; ?>" ></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input type="tel" name="telefono"  value="<?php echo $tlf; ?>"  required></td>
    </tr>
    <tr>
